...
- [SeaSideX ビルドガイド](#seasidex-ビルドガイド)
  ...
  - [2. 組み立て](#2-組み立て)
    ...
    - [2-8. 使用モデルに応じた配線](#2-8-使用モデルに応じた配線)
      ...
      - [2-8-3. SeaSide39(左手トラボ)用配線](#2-8-3-seaside39左手トラボ用配線)
...
> 購入前の注意事項は [`about.md`](about.md) をご確認ください。
...
LED配線済のバッテリー持続時間の注意点については「[注意事項: 1-6. LED配線によるバッテリー持続時間の違い](about.md#1-6-led配線によるバッテリー持続時間の違い)」セクションをご確認ください。
...
[注意事項: 1-6. LED配線によるバッテリー持続時間の違い](about.md#1-6-led配線によるバッテリー持続時間の違い)で説明した通り、SeaSideXをLED配線を行っているKeyballで使用する場合、点灯していないLEDの待機電力によってバッテリー持ちが悪くなることが報告されています。\
...
[注意事項: 1-3. ZMKファームウェアの使用](about.md#1-3-zmkファームウェアの使用)で説明したとおり、ZMK Studioを使用することでファームウェアを書き換えることなくGUIでキーマップを簡単に編集できます。\
